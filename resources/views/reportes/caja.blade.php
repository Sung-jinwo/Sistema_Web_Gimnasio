...
@section('page-subtitle', 'Cierres de caja y diferencias')
            ...
            <table data-card="compacta" class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th data-card-oculto class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Inicial</th>
                        <th class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Esperado</th>
                        <th data-card-oculto class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Entregado</th>
                        <th data-card-prioritario class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Diferencia</th>
