...
@section('page-subtitle', 'Inventario y stock de productos')
        ...
        <div class="overflow-x-auto">
            <table data-card="compacta" class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th data-card-oculto class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Código</th>
                        <th data-card-prioritario class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Producto</th>
                        <th data-card-oculto class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Categoría</th>
                        <th data-card-prioritario class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Precio</th>
                        <th data-card-prioritario class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Stock</th>
