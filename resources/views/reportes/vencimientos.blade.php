...
@section('page-title', 'Reporte de Vencimientos')
@section('page-subtitle', 'Membresías por vencer y vencidas')
            ...
            <table data-card="compacta" class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th data-card-oculto class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Teléfono</th>
