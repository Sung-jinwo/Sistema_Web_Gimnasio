...
@section('page-subtitle', 'Comisiones y penalizaciones por empleado')
            ...
            <table data-card="compacta" class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th data-card-prioritario class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Final</th>
                    </tr>
                </thead>
            ...
            <table data-card="compacta" class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th data-card-oculto class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Base</th>
                        <th data-card-oculto class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Penalización</th>
                        <th data-card-prioritario class="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">Final</th>
