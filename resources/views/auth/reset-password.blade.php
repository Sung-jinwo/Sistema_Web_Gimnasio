...
<head>
    ...
    <title>Restablecer Contraseña - SIGG</title>
...
<body class="bg-gradient-to-br from-pink-50 via-white to-purple-50 min-h-screen">
    <div class="min-h-screen flex flex-col items-center justify-center p-4">
        ...
        <div class="w-full max-w-md">
            <form method="POST" action="{{ route('password.update') }}" class="bg-white rounded-xl shadow-lg p-6 space-y-6">
                @csrf
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-gray-700 mb-2">
                        <i class="fas fa-lock mr-2 text-pink-600"></i>Nueva Contraseña
                    </label>
                    <input type="password" 
                           name="password" 
                           id="password" 
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700 mb-2">
                        <i class="fas fa-lock mr-2 text-pink-600"></i>Confirmar Nueva Contraseña
                    </label>
                    <input type="password" 
