...
<div class="container mx-auto px-4 py-6">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <div class="flex gap-2">
            <a href="{{ route('comisiones.mis-comisiones') }}" class="inline-flex items-center px-3 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition text-sm">
                <i class="fas fa-user mr-1"></i> Mis Comisiones
            </a>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 mb-4">
        <form method="GET" action="{{ route('comisiones.index') }}" class="flex flex-col sm:flex-row gap-3">
            ...
            <select name="tipo" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent">
                ...
                <option value="membresia" {{ request('tipo') === 'membresia' ? 'selected' : '' }}>Membresía</option>
            </select>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-center">
                            <div class="flex justify-center gap-2">
                                ...
                                <form action="{{ route('comisiones.liquidar', $comision->id_comision) }}" method="POST" class="inline" onsubmit="return confirm('¿Está seguro de liquidar esta comisión?')">
                                    @csrf
                                    <button type="submit" class="text-green-600 hover:text-green-900" title="Liquidar">
                    ...
                    @empty
                    <tr>
                        <td colspan="9" class="px-4 py-8 text-center text-gray-500">No se encontraron comisiones.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
