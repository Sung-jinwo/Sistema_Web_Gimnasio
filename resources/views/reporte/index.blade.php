...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <a href="{{ route('reportes.membresias') }}" class="bg-white rounded-lg shadow p-6 hover:border-pink-600 border-2 border-transparent transition-colors">
            <div class="w-12 h-12 bg-pink-600/10 rounded-lg flex items-center justify-center mb-4">
                <i class="fas fa-id-card text-pink-600 text-xl"></i>
            </div>
            <h3 class="text-lg font-semibold text-gray-900 mb-1">Reporte de Membresías</h3>
            <p class="text-sm text-gray-600">Historial de membresías y estados.</p>
        </a>
