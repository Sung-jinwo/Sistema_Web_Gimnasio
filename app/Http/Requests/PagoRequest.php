...
class PagoRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fecha_limite_pago' => 'nullable|date|after_or_equal:pag_inicio',
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'fecha_limite_pago.date' => 'La fecha límite debe ser una fecha válida.',
            'fecha_limite_pago.after_or_equal' => 'La fecha límite debe ser posterior o igual a la fecha de inicio.',
        ];
    }
}
